...
vmap ,tab :TBTrimAllBlank
nmap ,tab :TBTrimAllBlank
vmap ,tbl :TBTrimBlankLines
nmap ,tbl :TBTrimBlankLines
vmap ,ttb :TBTrimTrailing
nmap ,ttb :TBTrimTrailing
...
nnoremap ,  :noh
noremap ,r :MRU
noremap ,drum :de ~/Dropbox/MySites/ruminate
noremap ,dcpb :de ~/Dropbox/MySites/ptp/cpb
noremap ,d692 :cd ~/Dropbox/PERSONAL/ed692
noremap ,d603 :cd ~/Dropbox/PERSONAL/ed603
noremap ,dlt :cd ~/Dropbox/PERSONAL/letters-and-email
nnoremap ,ev :tabe ~/.vimrc
nmap ,q :wq!
nmap ,w :w!
noremap ,mp :silent !markdown2pdf -o %:r.pdf %:r.mtxt | open -a /Applications/Adobe\ Acrobat\ X\ Pro/Adobe\ Acrobat\ Pro.app/ %:r.pdf
noremap ,mv :silent !pandoc -f markdown -t html -s -o %:r.html %:r.mtxt | open -a /Applications/Google\ Chrome.app/Contents/MacOS/Google\ Chrome %:r.html
noremap ,m :silent !open -a Marked.app '%:p'
noremap / :call SearchCompleteStart()/
noremap G G$
xmap S <Plug>VSurround
nmap SO :so ~/.vim/Session.vim
...
set shortmess=aoO
badd +454 .vimrc
badd +1 ~/Dropbox/PERSONAL/ED603/markdown-syntax.mtxt
badd +1 ~/markdown-syntax-1.mtxt
badd +1 markdown-syntax-2.mtxt
silent! argdel *
edit ~/Dropbox/PERSONAL/ED603/markdown-syntax.mtxt
...
13
normal! 0
tabedit ~/markdown-syntax-1.mtxt
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
11
normal! 0
tabedit markdown-syntax-2.mtxt
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 310 - ((52 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
310
