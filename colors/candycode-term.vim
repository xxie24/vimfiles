...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi CursorLine term=underline cterm=NONE ctermbg=234 ctermfg=fg gui=NONE guibg=#212121 guifg=fg
    ...
    CSAHi Cursor term=NONE cterm=NONE ctermbg=118 ctermfg=16 gui=NONE guibg=#7cfc00 guifg=#000000
    CSAHi lCursor term=NONE cterm=NONE ctermbg=231 ctermfg=232 gui=NONE guibg=#ffffff guifg=#050505
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi ColorColumn term=reverse cterm=NONE ctermbg=124 ctermfg=fg gui=NONE guibg=#8b0000 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=154 ctermfg=16 gui=NONE guibg=#7cfc00 guifg=#000000
    CSAHi lCursor term=NONE cterm=NONE ctermbg=255 ctermfg=232 gui=NONE guibg=#ffffff guifg=#050505
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi CursorLine term=underline cterm=NONE ctermbg=80 ctermfg=fg gui=NONE guibg=#212121 guifg=fg
    ...
    CSAHi Cursor term=NONE cterm=NONE ctermbg=44 ctermfg=16 gui=NONE guibg=#7cfc00 guifg=#000000
    CSAHi lCursor term=NONE cterm=NONE ctermbg=79 ctermfg=16 gui=NONE guibg=#ffffff guifg=#050505
